          ...
          <div class="columns">
            <div class="column">
              <div class="field">
                ...
                <div class="control">
                  <input class="input" type="date" value="{{ $data->waktu_keberangkatan }}" name="waktu_keberangkatan" require>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="columns">
            <div class="column">
              <div class="field">
                ...
                <div class="control">
                  <input class="input" type="date" value="{{ $data->waktu_kedatangan }}" name="waktu_kedatangan" require>
                </div>
              </div>
            </div>
          </div>
          <div class="columns">
            <div class="column">
              <div class="field">
                ...
                <div class="control">
                  <input class="input" type="date" value="{{ $data->waktu_yang_ditempuh }}" name="waktu_yang_ditempuh" require>
                </div>
              </div>
            </div>
          </div>
